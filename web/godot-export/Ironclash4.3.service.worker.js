...
/** @type {string} */
const CACHE_VERSION = '1777142212|68281913';
/** @type {string} */
const CACHE_PREFIX = 'Ironclash4.3-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Ironclash4.3.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Ironclash4.3.html","Ironclash4.3.js","Ironclash4.3.offline.html","Ironclash4.3.icon.png","Ironclash4.3.apple-touch-icon.png","Ironclash4.3.worker.js","Ironclash4.3.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Ironclash4.3.wasm","Ironclash4.3.pck","Ironclash4.3.side.wasm","libterrain.web.debug.wasm32.wasm"];
